...
// "Not Started" (or anything blank/unrecognized) count as inactive. Mirrors
// the server's crImport.ts.
...
export const api = {
  ...
  // ph1-5_inactive is the subset that's "On Hold" or "Not Started" —
  // active per phase is derived as ph{n} - ph{n}_inactive wherever it's
  // shown, never stored on its own. Mirrors the server's POST
  // /api/cr-import exactly.
